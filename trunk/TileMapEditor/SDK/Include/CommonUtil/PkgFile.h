...
namespace Cactus
{
	...
	*/ 
	...
	public:
		...
		/**
		There will be a __time64_t saved in PkgFile for version 1.01 or upper.
		*/
		__time64_t		GetCreationTime();
		...
		*/ 
		...
		size_t			Read(SFATItem* pItem, void* buf, size_t size, size_t count);
