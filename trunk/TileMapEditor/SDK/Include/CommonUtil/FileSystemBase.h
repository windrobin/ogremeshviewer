...
namespace Cactus
{
	...
	{
	public:
		virtual size_t	Read(void* buf, size_t size, size_t count = 1) = 0; //return number of bytes actually read
	...
	public:
		...
		virtual bool				Delete(const Cactus::String& path, bool bEvenReadOnly = false) = 0;
		virtual bool				Rename(const Cactus::String& pathFrom
										, const Cactus::String& pathTo
										, bool bEvenReadOnly = false
										) = 0;
		virtual bool				Copy(const Cactus::String& pathFrom, const Cactus::String& pathTo) = 0;
